...
# Core LangChain imports with error handling
try:
...
class ChatEngine:
    ...
    def test_connection(self, model_name: str, base_url: str) -> bool:
        ...
        try:
            llm = Ollama(model=model_name, base_url=base_url, timeout=10)
    ...
    def _generate_chat_response(self, user_input: str, system_prompt: str, llm) -> str:
        ...
        try:
            conversation = ConversationChain(llm=llm, memory=self.memory)
